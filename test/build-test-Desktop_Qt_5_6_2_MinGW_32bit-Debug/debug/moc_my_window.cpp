...
struct qt_meta_stringdata_My_Window_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_My_Window_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_My_Window_t qt_meta_stringdata_My_Window = {
    {
QT_MOC_LITERAL(0, 0, 9) // "My_Window"
...
const QMetaObject My_Window::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_My_Window.data,
      qt_meta_data_My_Window,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *My_Window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_My_Window.stringdata0))
